...
def main():
    ...
    parser.add_argument("--loss_multiplier_robot", type=float, default=1.0)
    ...
    robot_dataset = get_data(args, image_processor, tokenizer, "robot")
    ...
    total_training_steps = (
       args.batch_size_robot * args.world_size
    ) * args.num_epochs
    ...
    for epoch in range(resume_from_epoch, args.num_epochs):
        robot_dataset.set_epoch(epoch)
        robot_loader = robot_dataset.dataloader
