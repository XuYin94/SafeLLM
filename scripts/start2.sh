...
for TASK_NAME in stack-block-pyramid-seq-seen-colors-primitive stack-block-pyramid-seq-seen-colors-relative-position
do

    python cliport/primitive_generator.py  task=$TASK_NAME  n=3000 mode=train data_dir=/mnt/lynx4/users/zhang/yinxu/Workfolder/data/primitive
