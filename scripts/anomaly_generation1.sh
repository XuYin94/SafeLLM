...
for action_error in True False; do
 for add_anomaly in True False; do
    python cliport/anomaly_generator_pack_boxes.py  task=pack-box-anomaly n=2000 data_dir=/mnt/bear1/users/zhangkang/yinxu/Workfolder/data/vlm add_action_error=$action_error add_anomaly=$add_anomaly
